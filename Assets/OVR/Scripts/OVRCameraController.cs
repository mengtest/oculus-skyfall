...
{		
	...
	private OVRCameraOverlay CameraOverlay;
	...
	new void Start()
	{
		...
		CameraOverlay = new OVRCameraOverlay();
	...
	public void OnGUI()
	{
		CameraOverlay.drawTexture();
	}

	public void FadeOut(float duration)
	{
		CameraOverlay.fadeOut(duration);
	}

	public void FadeIn(float duration)
	{
		CameraOverlay.fadeIn(duration);
	}
}
